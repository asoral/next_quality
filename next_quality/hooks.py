...
fixtures = [
    ...
    {"dt":"Custom Field", "filters": [["fieldname", "in", ("not_tested","quality_inspection_par","test_result","status","quality_inspection","selection","values","quality_inspection_parameter",
        "create_quality_inspection","custom_coa_print"  ,"quality_inspection_created","batch_no","quality_inspection","item_name","quality_inspection_created","selection","parameter_value","is_check","inspection_details",
