...
def before_insert(self,method):
	...
	if list:
	    frappe.throw("There is already a Quality Inspection created for {0} with same Inspection Type and Applicability. Please edit that inspection or delete and recreate one.".format(self.bom))
